  ...
  return (
    <div style={css("position:relative;")}>
      <div
        ...
        style={css("display:flex;gap:2px;overflow-x:auto;overscroll-behavior-x:contain;scroll-snap-type:x mandatory;scroll-padding-inline:var(--sp-1);-webkit-overflow-scrolling:touch;padding-bottom:4px;")}
      >
