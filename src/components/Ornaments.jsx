...
export function FlowerMark({ width = 130, height = 48, sw = 1.3, variant = "simple", style }) {
  return (
    <svg width={width} height={height} viewBox="0 0 160 56" style={{ overflow: "visible", ...(style || {}) }}>
      <g stroke="#7a5c86" strokeWidth={sw} fill="none" strokeLinecap="round">
      ...
      <circle cx="80" cy="7" r="4.5" fill="#6e4f7a" />
      <ellipse cx="54" cy="11" rx="7" ry="3.4" fill="#a685b0" transform="rotate(-32 54 11)" />
      <ellipse cx="106" cy="11" rx="7" ry="3.4" fill="#a685b0" transform="rotate(32 106 11)" />
    </svg>
  );
}
