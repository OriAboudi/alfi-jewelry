...
export const SEED_CONTENT = {
  ...
  authTagline: "תכשיטי כסף סטרלינג 925 בהשראת עולם הצומח — עדינים, חמים ונצחיים.",
  featuredKicker: "❀ נבחרי הקולקציה",
  featuredTitle: "פורחים השבוע",
  promoStripItems: [
    "✓ כסף סטרלינג 925 אמיתי",
    "✓ עיצוב ייחודי בהשראת הטבע",
  ...
  banner2Subtitle: "תכשיטים שנולדו מהשראת הטבע — כל פיסה מספרת סיפור אחר.",
  ...
  aboutText: "כל תכשיט ב‑ALFI נולד בהשראת הטבע ומעוצב בקפידה רבה. אנחנו מאמינים שהעדינות היא צורת היופי המתוחכמת ביותר.",
  storyImage: "floral-bg.jpg",
  storyKicker: "❀ הסיפור שלנו",
  storyTitle: "נולדנו מתוך אהבה לטבע",
  storyLead: "ALFI התחילה בשולחן עבודה קטן ופרח אחד שסירב להישכח. היום כל תכשיט שלנו עדיין נולד באותה דרך — בסבלנות, בדיוק ובאהבה.",
  storyBody: "אנחנו מלקטים השראה משדות, מגינות ומרגעים שקטים, ומתרגמים אותם לכסף סטרלינג 925. כל פיסה מעוצבת בקפידה, ללא קיצורי דרך.",
